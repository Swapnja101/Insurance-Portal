          ...
          <div className="lg:w-2/5 md:w-1/2 md:pr-10 md:py-6">
            <div className="flex relative pb-12">
              ...
              <div className="flex-grow pl-4">
                ...
                <p className="leading-relaxed">
                  Start by getting a personalized insurance quote that
            ...
            <div className="flex relative pb-12">
              ...
              <div className="flex-grow pl-4">
                ...
                <p className="leading-relaxed">
                  Compare different insurance plans and choose the one
            ...
            <div className="flex relative pb-12">
              ...
              <div className="flex-grow pl-4">
                ...
                <p className="leading-relaxed">
                  Easily enroll in the chosen insurance plan online
            ...
            <div className="flex relative pb-12">
              ...
              <div className="flex-grow pl-4">
                ...
                <p className="leading-relaxed">
                  Enjoy peace of mind with comprehensive insurance
                  coverage and access to a wide network of insurance providers.
                </p>
              </div>
            </div>
          </div>
