      ...
      <section className="text-gray-600 body-font relative bg-white">
        <div className="container px-5 py-10 mx-auto flex flex-wrap">
          <div className="lg:w-1/2 w-full mb-10 lg:mb-0">
            <div className="h-96 w-full bg-gray-300 rounded-lg overflow-hidden relative">
              <iframe
                title="Google Map"
                width="100%"
                height="100%"
                ...
                marginHeight="0"
                marginWidth="0"
                src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=Nowrosjee%20Wadia%20College,pune,maharashtra,india+(My%20Business%20Name)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
              ></iframe>
            </div>
          </div>
